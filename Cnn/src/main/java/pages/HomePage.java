...
public class HomePage extends CommonAPI {
    ...
    public void validateSearchPageDisplayed() {
        WebElement elementOfNewsTodayDisplay = elementByXpath("//div[@class='cnn-search__results-count']");
    ...
    public void validateWorldButton() {
        WebElement elementOfWorldButton = elementByXpath("//div[@class='Flex-sc-1sqrs56-0 headerstyles__HideOnMobile-sc-1vh4dor-9 kkGIDQ']//li[2]");
        Assert.assertEquals(elementOfWorldButton.isDisplayed(), true, "world button didn't displayed");
        elementOfWorldButton.click();
        WebElement valueOfWorldButton = elementByXpath("//h1[@class='metadata-header__title']");
        valueOfWorldButton.getText();
    }

    public void validateBusinessButton() {
        WebElement elementOfBusinessButton = elementByXpath("//div[@class='Flex-sc-1sqrs56-0 headerstyles__HideOnMobile-sc-1vh4dor-9 kkGIDQ']//li[4]");
    ...
    public void validateEditionButton() {
        WebElement elementOfEditionButton = elementByXpath("//div[@id='edition-picker-toggle-desktop']");
        Assert.assertEquals(elementOfEditionButton.isDisplayed(), true, "edition button is not displayed");
        elementOfEditionButton.click();
        WebElement valueOfEditionMethod = elementByXpath("//div[@class='Box-sc-1fet97o-0 edition-pickerstyles__Dropdown-t9lxqp-2 gTgbio']");
        Assert.assertEquals(valueOfEditionMethod.isDisplayed(), true, "value doesn'tdisplayed");
    }

    public void validateTrending() {
        WebElement elementOfTrending = elementByXpath("//span[@class='cd__pre-headline']");
    ...
    public void validateLiveTv() {
        WebElement elementOFLiveTV = elementByXpath("//span[@class='Text-sc-1amvtpj-0-span bcvWKK']");
        Assert.assertEquals(elementOFLiveTV.isDisplayed(), true);
        elementOFLiveTV.click();
    }

    public void validateTechLocator() {
        WebElement elementOfTech = elementByXpath("//h2[contains(text(),'Tech')]");
    ...
    public void validateScienceAndHealth() {
        WebElement elementOfScienceAndHealh = elementByXpath("//h2[contains(text(),'Science & Health')]");
