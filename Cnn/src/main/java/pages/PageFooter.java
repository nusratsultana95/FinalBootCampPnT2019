...
public class PageFooter extends CommonAPI {
    ...
    public void validateHealthButton(){
        homePage.menuIcon();
        WebElement elementOfHealth=elementByXpath("//div[@class='Box-sc-1fet97o-0 jSTOdN']//a[@name='health'][contains(text(),'Health')]");
        ...
        WebElement valueOfHealth=elementByXpath("//img[@class='metadata-header__logo']");
        Assert.assertEquals(valueOfHealth.isDisplayed(),true);
    }
    public void validateTermsAndUse(){
        WebElement elementOfTermsAndUse=elementByXpath("//a[@name='terms-of-use']");
        ...
        WebElement valueOfTermsAndUse=elementByXpath("//h1[@class='pg-headline']");
    ...
    public void validateLinkedtext(){
        WebElement elementOfFooterLinktext=elementByXpath("//div[@class='Flex-sc-1sqrs56-0 footerstyles__SocialWrap-sc-1gdpf6x-2 bJEKPs']//span[@class='Text-sc-1amvtpj-0-span jKFEoX'][contains(text(),'Follow CNN')]");
